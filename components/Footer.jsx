  ...
  return (
    <footer className="text-black dark:text-gray-300 border-t border-gray-200 dark:border-gray-800 pt-14 pb-10 px-4 md:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 text-sm">
        ...
        <div className="col-span-1">
          <div className="flex items-center gap-2 mb-4">
            <img src="/unipath-icon.svg" alt="UniPath Logo" className="h-8 w-auto" />
        ...
        <div>
          ...
          <div className="flex gap-4 mt-6">
            <a
              href="https://github.com/Sahil-u07"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/sahil-lenka-3608a2311/"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-primary transition-colors"
            >
      ...
      <div className="text-center text-gray-500 dark:text-gray-400 text-xs mt-10">
        © {new Date().getFullYear()} UniPath. Built with 💡 by UniPath Team.
      </div>
    </footer>
  );
}
