...
export const metadata = {
  title: "UniPath - Your AI-Powered Career Assistant",
  description:
    ...
    <ClerkProvider appearance={{ baseTheme: dark }}>
      <html lang="en" suppressHydrationWarning className="dark">
        <head>
          ...
          <link rel="icon" href="/unipath-icon.svg" type="image/svg+xml" />
          {/* SEO Meta Tags */}
          ...
          <meta property="og:url" content="https://unipath.com" />
          <meta property="og:image" content="https://unipath.com/og-image.png" />

          {/* Twitter Card Meta Tags */}
          <meta name="twitter:card" content="summary_large_image" />
          <meta name="twitter:title" content={metadata.title} />
          <meta name="twitter:description" content={metadata.description} />
          <meta name="twitter:image" content="https://unipath.com/og-image.png" />
        </head>
